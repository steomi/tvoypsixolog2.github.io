...
setTimeout(function () {
  ...
  document.querySelector("html").classList.add("after");
}, 3000);

setTimeout(function () {
  document.querySelector(".content").classList.add("emergence");
  document.querySelector("footer").classList.add("emergence");
}, 4200);
